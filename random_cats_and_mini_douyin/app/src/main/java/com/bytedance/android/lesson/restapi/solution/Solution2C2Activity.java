...
public class Solution2C2Activity extends AppCompatActivity {
    ...
    private static final String mStudentId = "1120162016";
    private static final String mUserName = "abogiegie";
    ...
    private void postVideo() {
        ...
        Call<PostVideoResponse> postVideoResponseCall = NetworkUtils.getPostVideoResponseWithRetrofitAsync(mStudentId, mUserName, image, video);
        Log.d(TAG, "postVideo: " + postVideoResponseCall);
    ...
    public void fetchFeed(View view) {
        ...
        Call<FeedResponse> feedResponseCall = NetworkUtils.getFeedResponseWithRetrofitAsync();
