...
public class NetworkUtils {
    ...
    public static Call<List<Cat>> getCatResponseWithRetrofitAsync() {
    ...
    public static Call<FeedResponse> getFeedResponseWithRetrofitAsync(){
        Retrofit retrofit = new Retrofit.Builder()
    ...
    public static Call<PostVideoResponse> getPostVideoResponseWithRetrofitAsync(
